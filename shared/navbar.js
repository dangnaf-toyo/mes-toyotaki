...
(function () {
  const MENU = [
    ...
    { label: 'Sản xuất', items: [
      ...
      { label: 'Bảng điều khiển Đánh bóng', href: 'cong-doan-dashboard.html?cd=%C4%90%C3%A1nh+b%C3%B3ng' },
  ...
  const PAGE_META = {
    ...
    'cong-doan-bao-cao-ca.html': { icon: '📋', title: 'Báo Cáo Cuối Ca — Ngoài Đúc', desc: 'Bavia / Gia công / Cắt viền / Đánh bóng / Sơn / OQC', noTitleBar: true },
    ...
    'khsx-tuan.html': { icon: '📅', title: 'Kế Hoạch Sản Xuất Tuần', desc: 'Đúc / Bavia / Gia công / Cắt viền / Đánh bóng / Sơn / OQC — 1 màn hình, chuyển tab', noTitleBar: true },
