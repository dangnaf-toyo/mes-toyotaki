-- ============================================================================
-- D49 — duc_tao_lo_kanban: số lượng / thùng LẤY THEO master_products.sl_dong_goi_chuan
-- (không nhập tay). p_sl_thung giờ là optional — bỏ trống / <=0 thì tự tra
-- danh mục; nếu danh mục cũng chưa khai thì báo lỗi rõ ràng.
--
-- Giữ nguyên chữ ký hàm (p_sl_thung numeric vẫn còn) → create or replace,
-- không cần cấp lại quyền.
...
begin
  ...
  -- Số lượng / thùng: ưu tiên danh mục (sl_dong_goi_chuan). p_sl_thung chỉ là
  -- dự phòng khi danh mục chưa khai.
